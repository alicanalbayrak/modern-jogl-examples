...
public class MaterialTexture extends Framework {
    ...
    private void setupMaterials(GL3 gl3) {
        ...
        MaterialBlock mtl = new MaterialBlock(new Vec4(1.0f, 0.673f, 0.043f, 1.0f),
                new Vec4(1.0f, 0.673f, 0.043f, 1.0f).mul(new Vec4(0.4f)), 0.125f);
    ...
    private void createShininessTexture(GL3 gl3) {
        ...
        try {
            ...
            File file = new File("/home/elect/NetBeansProjects/modern-jogl-examples/modern-jogl-examples/tut14/data/main.dds");
    ...
    public void display(GL3 gl3) {
        ...
        if (drawLights) {
            ...
            modelMatrix.translate(globalLightDirection.mul_(new Vec3(100.0f))).scale(5.0f);
